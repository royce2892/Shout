...
public class PhraseFragment extends Fragment {
    ...
    public static PhraseFragment newInstance(String location) {
        final PhraseFragment phraseFragment = new PhraseFragment();
    ...
    private void getPhrase(String location) {
        ...
        query.getFirstInBackground(new GetCallback<ParseObject>() {
            ...
            public void done(ParseObject parseObject, ParseException e) {
                if (e == null) {
                    PhraseAdapter adapter = new PhraseAdapter(parseObject.getString("local"),getActivity());
